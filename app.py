...
df_scatter_indexed = df_scatter.set_index('Region')
...
app.layout = html.Div(children=[
    ...
    dbc.Container([
        ...
        dbc.Row(html.H1(children="Philippine Risk Information per Province")),
        ...
        dbc.Col(children=[
            ...
            # dbc.Col(children=[# health personnel to population scatter
                dbc.Row(children=[
                    dbc.Col(children=[
                        html.H5("Province Population to Number of Health Personnel with Average Disaster Risk",
                            id="scatterplot-title"),
                    ...
                    dbc.Col(children=[
                        html.Br(),
                        html.Br(),
                        html.H6("Select a Second Region",
                                    id="scatter-btns-title",
                                    style={
                                        "font-size": "16px"
                                    }
                                ),

                        dcc.RadioItems(region_options, 
                                        region_options[0]['value'], 
                                        id='scatter-select-region',
                                        inline=False,
                                        className='mb-2',
                                        style={
                                            "width": 250,
...
@callback(
    ...
    Input("region-select", "value"),
    Input("scatter-select-region", "value"),
)
def scatter_plot(selected_region1, selected_region2):
    region1 = df_scatter_indexed.loc[selected_region1]
    region2 = df_scatter_indexed.loc[selected_region2]
